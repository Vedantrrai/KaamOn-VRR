          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                  <Link href="/services">
                      <Button size="lg" className="bg-red-500 hover:bg-red-600 text-white text-lg px-8 w-full sm:w-auto">
                          Book a Service
                          <ArrowRight className="ml-2 w-5 h-5" />
                      </Button>
                  </Link>
                  <Link href="/signup">
                      <Button size="lg" variant="ghost" className="bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-800 dark:text-white text-lg px-8 w-full sm:w-auto">
                          Become a Worker
                      </Button>
                  </Link>
              </div>
