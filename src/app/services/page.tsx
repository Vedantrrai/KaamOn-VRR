...
import { services, workers, Worker } from '@/lib/mockData';
import { Star, Search, Clock, Award } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
          ...
          >
                ...
                {workerCategories.map((category) => (
                  <Button
                    ...
                    className={`rounded-md transition-all ${
                      selectedCategory === category ? 'gradient-orange-blue text-white shadow-sm' : ''
                    }`}
                  >
                    {category}
                  </Button>
            ...
            {filteredWorkers.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-muted-foreground text-lg">No workers found matching your criteria</p>
              </div>
            )}
          </motion.div>
        </div>
            ...
            <Card className="p-4 bg-green-500/10 border-green-500/20">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold mt-2 text-green-600">Estimated: ₹{selectedWorker?.hourlyRate} - ₹{(selectedWorker?.hourlyRate || 0) * 2}</p>
                </div>
              </div>
            </Card>
